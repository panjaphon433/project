  ...
  <div class="container d-flex justify-content-center align-items-center h-100">
    <div class="card">
      ...
      <form>
        ...
        <h1  align ="center" class="h1 mb-3 fw-normal form-header">กรุณาเข้าสู่ระบบ</h1>

        <div class="form-floating d-flex align-items-center">
          <input type="text" class="form-control" placeholder="เลขประจำตัวประชาชน" ng-model="s.admin_username">
        ...
        <div class="form-floating d-flex align-items-center">
          <input type="password" class="form-control" placeholder="รหัสผ่าน" ng-model="s.admin_password">
