        ...
        <div class="modal-body">
          <table class="table table-hover" >
            <thead class="header-content">
              ...
              <th class="text-end" rowspan="2"></th>บัตรประจำตัวประชาชนคู่สมรส</tr>
                    ...
                    <div class="form-row">
                      <div class="row g-3">
                        ...
                        <div class=" form-group col-sm-4 mb-3">
                          ...
                          <input ng-model="f.idcard" type="text" class="form-control" placeholder="กรุณากรอกเลขประจำตัวประชาชนผู้ป่วย" required />
                        </div>
                        <div class="mb-3">
                          <label htmlFor="sex" Class="form-lable">
                            เพศ:
                        ...
                        <div class="mb-3">
                          ...
                          <input ng-model="f.phone" type="text" class="form-control" placeholder="XXX XXXXXXX" required />
                        </div>
                        <div class="mb-3">
                          <label htmlFor="address" Class="form-lable">
                            ที่อยู่:
                        ...
                        <div class="mb-3">
                          ...
                          <input ng-model="f.mom_idcard" type="text" class="form-control" placeholder="X XXXX XXXXX XX X" />
                        </div>
                        <div class="mb-3">
                          <label htmlFor="dad_name" Class="form-lable">
                            ชื่อบิดา:
                        ...
                        <div class="mb-3">
                          ...
                          <input ng-model="f.dad_idcard" type="text" class="form-control" placeholder="X XXXX XXXXX XX X" />
                        </div>
                        <div class="mb-3">
                          <label htmlFor="spouse_name" Class="form-lable">
                            ชื่อคู่สมรส:
                        ...
                        <div class="mb-3">
                          ...
                          <input ng-model="f.spouse_idcard" type="text" class="form-control" placeholder="X XXXX XXXXX XX X" />
                        </div>
                        <div class="mb-3">
                          <label htmlFor="password" Class="form-lable">
                            รหัสผ่าน:
